 ...
 *  File            : SSC_Alloc.h
 *
 *  Description     : This header file defines the SSC memory allocation macros.
 *
...
#define SSC_MALLOC(size, comment)	        malloc(size)
#define SSC_CALLOC(num, size, comment)      calloc(num, size)
#define SSC_FREE(ptr, comment)              free(ptr)
