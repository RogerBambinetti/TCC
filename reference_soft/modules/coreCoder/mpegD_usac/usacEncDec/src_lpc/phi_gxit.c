...
/*======================================================================*/
/* Function Definition: reset_cba_codebook_dec                          */
/*======================================================================*/
 
void reset_cba_codebook_dec (float PHI_adaptive_cbk [], long  max_lag)
{
    int i;   

    for (i = 0; i < (int)max_lag; i++)
    {
        PHI_adaptive_cbk[i] = 0.0F;
    }
}
