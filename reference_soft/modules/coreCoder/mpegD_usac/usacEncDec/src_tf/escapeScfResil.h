...
#ifndef _ESCAPE_SCF_RESIL_H_
#define _ESCAPE_SCF_RESIL_H_

typedef struct tag_escape * Escape;


void   InitEscape    ( Escape escStruct, int * escValArray );
void   AddEscValue   ( Escape escStruct, int value );
int    GetNumOfValues( Escape escStruct );
int    GetLastValue  ( Escape escStruct );
Escape CreateEscape  ( void );

#endif /* _ESCAPE_SCF_RESIL_H_ */
