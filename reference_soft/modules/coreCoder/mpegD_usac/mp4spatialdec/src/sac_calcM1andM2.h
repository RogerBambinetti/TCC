...
#include "ic_rom.h" /* only for the RM6_INTERNAL_CHANNEL. it can be removed later */
...
void SpatialDecApplyM2_IC(spatialDec* self);
void SpatialDecApplyM2_InvIC(spatialDec* self);
#endif
