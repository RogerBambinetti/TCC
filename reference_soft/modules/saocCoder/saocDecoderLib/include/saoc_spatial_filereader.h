...
#ifndef _SAOC_SPATIAL_FILEREADER_H_
#define _SAOC_SPATIAL_FILEREADER_H_
...
typedef struct FILE_READER *HANDLE_FILE_READER;

extern HANDLE_FILE_READER FileReaderOpen(char *fileName);

extern void FileReaderClose(HANDLE_FILE_READER self);

extern int FileReaderEof(HANDLE_FILE_READER self);

extern HANDLE_BYTE_READER FileReaderGetByteReader(HANDLE_FILE_READER self);
