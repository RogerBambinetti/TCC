...
#ifndef __SAOC_ENCODER_H__
#define __SAOC_ENCODER_H__
...
void InitDownmixMat(char* pInName, float pMat[MAX_NUM_OUTPUTCHANNELS][MAX_NUM_INPUTCHANNELS],int nInChannels,int nChannelNumber);
