...
/*
 ...
 $Id: SubbandDirSigsPrediction.h 196 2015-10-12 11:45:11Z technicolor-ks $
*/
...
class SubbandDirSigsPrediction
{
	public:

		SubbandDirSigsPrediction();
    ...
    private:
        ...
        unsigned int m_uiFirstSBRSubbandIdx;
        ...
        // temporary variables
        std::vector<std::vector<std::complex<FLOAT> > > m_vvcFZeroCoeffMat;
        std::vector<FLOAT> m_vFTmpModeVec;
        std::vector<FLOAT> m_vFTmpPInvModeVec;

        std::set<unsigned int>  m_suiOldActiveAmbHOACoeffsIndices;
};
