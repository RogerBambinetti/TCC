...
/*
 ...
 $Id: PreliminaryHOAComposition.h 196 2015-10-12 11:45:11Z technicolor-ks $
*/
#pragma once
...
class PreliminaryHOAComposition
{
	public:
		PreliminaryHOAComposition();

		bool init( unsigned int p_uiFrameSize,
                   int p_iMaxPARHOAOrder,
                   unsigned int p_uiHOAOrder);

		bool process(   const std::vector<std::vector<FLOAT> > & p_rvvFInputPreDomSoundHOACoeffsFrame,
	...
	private:
      ...
      unsigned int m_uiMaxNoOfPARUpmixSigs;
