...
/*
 ...
 $Id: InverseDynCorrection.h 157 2015-01-16 14:00:35Z technicolor-kf $
*/
#pragma once
...
class InverseDynCorrection
{
	public:

		InverseDynCorrection(); 

		bool init(unsigned int p_uiFrameSize);

		bool process(const std::vector<FLOAT>& p_vFInputSampleBuffer, std::vector<FLOAT>& p_vFOutputSampleBuffer, bool p_bException, int p_iExponent);

        bool setLastGain(int iExponentToBase2);
