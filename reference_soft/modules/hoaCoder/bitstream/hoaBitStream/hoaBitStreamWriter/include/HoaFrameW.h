...
/*
 ...
 $Id: HoaFrameW.h 196 2015-10-12 11:45:11Z technicolor-ks $
*/

#pragma once

#ifndef __HoaFrameW__
#define __HoaFrameW__

#include "choabitstream.h"
#include "basicbitstreamfieldswrite.h"


class HoaFrameW : public IBitStreamFieldWrite,
                        public HoaFrameIO<UCHAR_FW,
                                              INT_FW,
                                              UINT_FW> 
{
   public:
   ...
   private:
      unsigned int writeDiffValues(bool bUseRealCoeffsPerSubband,            
         int nMagDiff,
         ...
         UCHAR_FW *pBool1Bit);
      int writeUnaryCode(unsigned int nVal, UCHAR_FW *pBool1Bit);
