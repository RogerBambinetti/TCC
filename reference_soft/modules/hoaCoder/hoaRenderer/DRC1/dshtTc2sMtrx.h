...
$Id: dshtTc2sMtrx.h 203 2016-01-19 13:45:41Z technicolor-ks $
*/


#ifndef __DSHTC2SMTRX_H__
#define __DSHTC2SMTRX_H__

#include"SimpleMtrx.h"
#include <stdexcept>

//#define USE_PREPROCESSEDMTRX
...
class dshtTc2sMtrx
{
 public:
    ...
    // construct matrix  (dshtDrcMtrxRom1.h or dshtDrcMtrxRom2.h, depending on define, reason: fast load or demonstrate calculation)
#ifdef USE_PREPROCESSEDMTRX
    dshtTc2sMtrx( int HOAorder, bool bCalcFramPositions=true);
#else
    dshtTc2sMtrx( int HOAorder); 
#endif
    ...
    //Ptr to simpleMtrx -> returns a pointer to ansimpleMtrx member
   simpleMtrx * getMtrxPtr()  {return &m_Dmatrix;} 

    
    // getters
    int getHOAorder() { return m_HOAorder;}
    int getNumberOfSpeakers() {return m_cols; }
