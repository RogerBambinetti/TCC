...
* functionality:    Matrix class : spherical harmonics mode matrix (MPEG-H-RM3)
...
$Id: sHmodeMtrx.h 157 2015-01-16 14:00:35Z technicolor-kf $
*/


#ifndef __SHMODEMTRX_H__
#define __SHMODEMTRX_H__
...
class sHmodeMtrx
{
 public:
    ...
    // construct matrix  
    sHmodeMtrx( int HOAorder, double *theta, double *phi, int numPositions);
    ...
    //Ptr to simpleMtrx -> returns a pointer to simpleMtrx member
    simpleMtrx * getMtrxPtr()  {return &m_Dmatrix;} 

    
    // getters
    int getHOAorder() { return m_HOAorder;}
    int getNumberOfPositions() {return m_Lpositions; }
