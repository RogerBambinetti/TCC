...
$Id: sphericalHarmonic.h 157 2015-01-16 14:00:35Z technicolor-kf $
*/
...
double sphericalHarmonics(int n,            // order index >=0
                          int m,            // degree index -n<=m<=n
                          double theta,     // inclination angle (from z-axis) in rad 
                          double phi        // azimuth angle (from x (front), counter clockwise) in rad
                          );

#endif // __SPHERICALHARMONIC_H__