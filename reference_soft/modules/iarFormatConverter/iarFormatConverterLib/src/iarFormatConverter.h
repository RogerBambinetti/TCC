...
#ifndef _IAR_FORMATCONVERTER_H_
#define _IAR_FORMATCONVERTER_H_
...
/* default parameters */
#define IAR_FORMAT_CONVERTER_MAX_CHANNELS 24   
    
/**********************************************************************************************************************************/

typedef struct IAR_T_FORMAT_CONVERTER_PARAMS
{
    ...
    /** Needs to be set, if the IAR_FORMAT_CONVERTER_MODE == IAR_FORMAT_CONVERTER_MODE_CUSTOM_FREQ_DOMAIN */
    ...
    iar_converter_formatid_t formatConverterInputFormat_internal;
    
    /** format converter output format of internal init structure */
    iar_converter_formatid_t formatConverterOutputFormat_internal;
    
    
    /** handle to internal init structure*/
    iar_converter_pr_t *formatConverterParams_internal;
    ...
    /* the secondary downmix matrix for the timbral elevation rendering */
#if IAR
    float **dmxMtx2;
    float ***dmxMtxFreq2;
#endif
...
} IAR_FORMAT_CONVERTER_PARAMS;

/**********************************************************************************************************************************/

typedef struct IAR_T_FORMAT_CONVERTER_STATE
{
...
} IAR_FORMAT_CONVERTER_STATE;

/***********************************************************************************************************/
/** internal functions **/
/***********************************************************************************************************/

int iar_formatConverterGetNumInputChans( const IAR_FORMAT_CONVERTER_INPUT_FORMAT formatConverterInputFormat );                                    
    
/***********************************************************************************************************/

int iar_formatConverterGetNumOutputChans( const IAR_FORMAT_CONVERTER_OUTPUT_FORMAT formatConverterOutputFormat );                                
