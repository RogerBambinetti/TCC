...
#ifndef _IAR_FORMATCONVERTER_API_H_
#define _IAR_FORMATCONVERTER_API_H_
...
typedef enum
{
    ...
    IAR_API_CH_M_R060 =     8,
    IAR_API_CH_M_L090 =     9,
    IAR_API_CH_M_R090 =     10,
    IAR_API_CH_M_L110 =     11,
    IAR_API_CH_M_R110 =     12,
    IAR_API_CH_M_L135 =     13,
    IAR_API_CH_M_R135 =     14,
    IAR_API_CH_M_L150 =     15,
    IAR_API_CH_M_R150 =     16,
    IAR_API_CH_M_180 =      17,
    /* height channels */
    IAR_API_CH_U_000 =      18,
    IAR_API_CH_U_L045 =     19,
    IAR_API_CH_U_R045 =     20,
    IAR_API_CH_U_L030 =     21,
    IAR_API_CH_U_R030 =     22,
    IAR_API_CH_U_L090 =     23,
    IAR_API_CH_U_R090 =     24,
    IAR_API_CH_U_L110 =     25,
    IAR_API_CH_U_R110 =     26,
    IAR_API_CH_U_L135 =     27,
    IAR_API_CH_U_R135 =     28,
    IAR_API_CH_U_180 =      29,
    /* top channel */
    IAR_API_IAR_CH_T_000 =      30,
    /* low channels */
    IAR_API_IAR_CH_L_000 =      31,
    IAR_API_IAR_CH_L_L045 =     32,
    IAR_API_IAR_CH_L_R045 =     33,
    /* low frequency effects */
    IAR_API_IAR_CH_LFE1 =       34,
    IAR_API_IAR_CH_LFE2 =       35,
    /* empty channel */
    IAR_API_IAR_CH_EMPTY =      -1
} iar_api_chid_t;

/** Handle to Format Converter parameter struct.
    Holds Format Converter parameter data. */
typedef struct IAR_T_FORMAT_CONVERTER_PARAMS    *IAR_HANDLE_FORMAT_CONVERTER_PARAMS;

/** Handle to Format Converter state struct.
    Holds Format Converter state data. */
typedef struct IAR_T_FORMAT_CONVERTER_STATE    *IAR_HANDLE_FORMAT_CONVERTER_STATE;
...
} iar_pkFilterParamsStruct;

/* parameters struct for EQ definition */
typedef struct {
    int nPkFilter;                        /* number of cascaded peak filters */
    float G;                              /* global gain [dB]                */
    iar_pkFilterParamsStruct *pkFilterParams; /* pointer to nPkFilter-element array of pkFilterParamsStructs */
} iar_eqParamsStruct;

/** Supported Format Converter processing modi.
    IAR_FORMAT_CONVERTER_MODE_INVALID = 0                    : invalid processing mode. \n
    IAR_FORMAT_CONVERTER_MODE_PASSIVE_TIME_DOMAIN            : .  \n
    IAR_FORMAT_CONVERTER_MODE_PASSIVE_FREQ_DOMAIN            : .  \n
    IAR_FORMAT_CONVERTER_MODE_ACTIVE_FREQ_DOMAIN_PHASE_ALIGN : .  \n*/    
typedef enum
{
    IAR_FORMAT_CONVERTER_MODE_INVALID = 0,
    IAR_FORMAT_CONVERTER_MODE_PASSIVE_TIME_DOMAIN,
    IAR_FORMAT_CONVERTER_MODE_PASSIVE_FREQ_DOMAIN,
    IAR_FORMAT_CONVERTER_MODE_ACTIVE_FREQ_DOMAIN_PHASE_ALIGN,
    IAR_FORMAT_CONVERTER_MODE_CUSTOM_FREQ_DOMAIN_PHASE_ALIGN,
    IAR_FORMAT_CONVERTER_MODE_ACTIVE_FREQ_DOMAIN_STFT,
    IAR_FORMAT_CONVERTER_MODE_CUSTOM_FREQ_DOMAIN_STFT
} IAR_FORMAT_CONVERTER_MODE;
      
/** Supported Format Converter input formats (IIS channel order).
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_INVALID = 0       : invalid input format. \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_5_1               : 5.1 input format (default channel order).   \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_5_2_1 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_7_1 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_7_1_ALT \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_10_1 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_22_2              : 22.2 input format (IIS channel order).  \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_14_0              : 14.0 input format (IIS channel order).  \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_9_1 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_9_0               : 9.0 input format (IIS channel order).   \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_11_1              : 11.1 input format (IIS channel order).  \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_4_4_0 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_4_4_T_0 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_3_0_FC \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_3_0_RC \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_4_0 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_5_0 \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_6_1  \n
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_LISTOFCHANNELS \n    
 IAR_FORMAT_CONVERTER_INPUT_FORMAT_GENERIC \n*/    
typedef enum
{
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_INVALID = 0,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_5_1,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_5_2_1,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_7_1,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_7_1_ALT,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_10_1,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_22_2,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_14_0,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_9_1,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_9_0,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_11_1,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_4_4_0,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_4_4_T_0,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_3_0_FC,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_3_0_RC,
    ...
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_LISTOFCHANNELS,
    IAR_FORMAT_CONVERTER_INPUT_FORMAT_GENERIC
} IAR_FORMAT_CONVERTER_INPUT_FORMAT;
  
/** Supported Format Converter output formats (IIS channel order).
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_INVALID = 0    : invalid output format. \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_1_0            : 1.0 output format (default channel order).  \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_2_0            : 2.0 output format (default channel order).  \n    
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_5_1            : 5.1 output format (default channel order).  \n    
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_5_2_1 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_7_1 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_7_1_ALT \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_8_1            : 8.1 output format (IIS channel order).      \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_10_1           : 10.1 output format (IIS channel order).     \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_9_1 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_9_0 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_11_1 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_4_4_0 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_4_4_T_0 \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_3_0_FC \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_3_0_RC \n
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_4_0 \n 
 IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_5_0 \n
 FORMAT_CONVERTER_OUTPUT_FORMAT_6_1 \n
 FORMAT_CONVERTER_OUTPUT_FORMAT_LISTOFCHANNELS \n
 FORMAT_CONVERTER_OUTPUT_FORMAT_GENERIC \n*/
typedef enum
{
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_INVALID = 0,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_1_0,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_2_0,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_5_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_5_2_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_7_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_7_1_ALT,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_8_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_10_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_9_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_9_0,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_11_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_4_4_0,
    ...
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_4_0,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_5_0,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_6_1,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_LISTOFCHANNELS,
    IAR_FORMAT_CONVERTER_OUTPUT_FORMAT_GENERIC
} IAR_FORMAT_CONVERTER_OUTPUT_FORMAT;
...
/**
  ...
  */
int iar_formatConverterMatchChConfig2Channels(
        ...
        iar_api_chid_t             **channel_vec,   /* out:  vector containing channel enums */
...
int  iar_formatConverterOpen(    
                        const IAR_FORMAT_CONVERTER_MODE          formatConverterMode,  
                        const IAR_FORMAT_CONVERTER_INPUT_FORMAT  formatConverterInputFormat,
                        const IAR_FORMAT_CONVERTER_OUTPUT_FORMAT formatConverterOutputFormat,
                        ...
                        int                                  *numOutputChans,
                        int                                  *delaySamples,
                        IAR_HANDLE_FORMAT_CONVERTER_PARAMS       *phFormatConverter_params,
                        IAR_HANDLE_FORMAT_CONVERTER_STATE        *phFormatConverter_state );
...
/** Format Converter processing in time domain.
    ...
    \param hFormatConverter_state A handle to Format Converter state struct.    
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterProcess_timeDomain( 
...
/** Format Converter processing in frequency domain.
    ...
    \param hFormatConverter_state A handle to Format Converter state struct.    
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterProcess_freqDomain( 
...
int  iar_formatConverterProcess_freqDomain_STFT( 
...
/** Get DMX Matrix of Format Converter.
    ...
    \param hFormatConverter_params A handle to Format Converter parameter struct
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterGetDmxMtx(
                               float **dmxMtx,
                               IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params);    
...
/** Postprocess DMX gains matrix. 
    ...
    \return Returns 0 on success, otherwise 1.    */
int iar_formatConverterPostprocessDmxMtx(
                                float **dmxMtx,
...
/** Set DMX Matrix of Format Converter.
    ...
    \param hFormatConverter_state A handle to Format Converter state struct.         
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterSetDmxMtx(
                                const float **dmxMtx,
                                IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params,
                                IAR_HANDLE_FORMAT_CONVERTER_STATE hFormatConverter_state);
...
/** Add DMX Matrix to Currently Active DMX Matrix (element wise addition).
    ...
    \param hFormatConverter_state A handle to Format Converter state struct.         
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterAddDmxMtx(
                                const float **dmxMtx,
                                IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params,
                                IAR_HANDLE_FORMAT_CONVERTER_STATE hFormatConverter_state);
...
/** Set EQs of Format Converter.
    ...
    \param hFormatConverter_state A handle to Format Converter state struct.         
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterSetEQs(
                             int numEQs,
                             iar_eqParamsStruct *eqParams,
                             int *eqMap,
                             float *bands_nrm,
                             float sfreq_Hz,
                             IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params,
...
/** Get Mix Matrix of Format Converter.
    ...
    \param hFormatConverter_params A handle to Format Converter parameter struct
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterGetMixMtx(
                                int **mixMtx,
                                IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params);
...
/** Get trim parameters of Format Converter.
    ...
    \param hFormatConverter_params A handle to Format Converter parameter struct
    \return Returns 0 on success, otherwise 1.    */
int  iar_formatConverterGetTrimParams(
                                float *trimGains,
                                int *trimDelays,
                                IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params);
...
int iar_formatConverterGetDelaySamples( IAR_FORMAT_CONVERTER_MODE mode );
...
/** Display Format Converter parameters.
    ...
    \param hFormatConverter_params A handle to Format Converter parameter struct.
    \return Returns 0 on success, otherwise 1.  */    
int iar_formatConverterDisplayParams( int mode, const IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params );


/** Get build info of Format Converter.
    Build date and time of Format Converter.
    \return Returns string of build date and time.  */    
const char *iar_formatConverterGetInfo( void );   


int iar_setCustomDownmixParameters( IAR_HANDLE_FORMAT_CONVERTER_STATE formatConverter_state, int adaptiveEQStrength, int phaseAlignStrength);
int iar_setCustomDownmixParameter_STFT( IAR_HANDLE_FORMAT_CONVERTER_STATE formatConverter_state, int adaptiveEQStrength);

int iar_formatConverterSetDmxMtx_STFT(const IAR_HANDLE_FORMAT_CONVERTER_PARAMS hFormatConverter_params, IAR_HANDLE_FORMAT_CONVERTER_STATE hFormatConverter_state);
