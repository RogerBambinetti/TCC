...
#ifndef __DYNAMIC_OBJECT_PRIORITY_GENERATOR_H__
#define __DYNAMIC_OBJECT_PRIORITY_GENERATOR_H__

typedef struct _DYNAMIC_OBJECT_PRIORITY_GENERATOR* DYNAMIC_OBJECT_PRIORITY_GENERATOR_HANDLE;
