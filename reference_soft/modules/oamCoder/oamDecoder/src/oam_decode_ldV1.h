...
/**
 * @file oam_decode_ldV1.h
 * @brief LD-V1 object metadata decoder
 * @author Christian Borss <christian.borss@iis.fraunhofer.de>
 *
 * @date 31.07.2013 - first version
 *
 * @version 0.1
 */


#ifndef  __OAM_DECODE_ldV1_H__
#define  __OAM_DECODE_ldV1_H__
 ...
 *
 * This is the toplevel function of the LD-V1 object metadata decoder.
 *
